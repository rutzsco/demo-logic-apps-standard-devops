...
Two CICD pipelines have been created with YML. 
...
An additional "Easy Button" CICD pipeline has been created that combines the two steps into one job to simplify the deploy.

- [easy-button-pipeline.yml](Infrastructure/yml/easy-button-pipeline.yml)
